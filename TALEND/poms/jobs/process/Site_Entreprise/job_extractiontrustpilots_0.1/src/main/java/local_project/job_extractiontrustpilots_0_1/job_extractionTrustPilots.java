...
public class job_extractionTrustPilots implements TalendJob {
	...
	public static class a_pour_service_siteStruct
			implements routines.system.IPersistableRow<a_pour_service_siteStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_job_extractionTrustPilots = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_job_extractionTrustPilots = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String insertIgnore_tDBOutput_1 = "INSERT IGNORE INTO `" + "service_web"
						+ "` (`url_service`,`nom`,`description`,`adresse`,`telephone`,`email`) VALUES (?,?,?,?,?,?) ON DUPLICATE KEY UPDATE `nom` = ?,`description` = ?,`adresse` = ?,`telephone` = ?,`email` = ?";
...
// # Filter conditions 
							...
							Var.categories != null
								...
								a_pour_service_site_tmp.nom = row1.categories.replaceAll("\\[\"", "")
										.replaceAll("\"\\]", "").replaceAll("&#039;", "'");
...
// Start of branch "service_web"
						if (service_web != null) {
							...
							if (service_web.url_service == null) {
								...
								pstmt_tDBOutput_1.setString(1, service_web.url_service);
							}

							if (service_web.nom == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, service_web.nom);
							}

							if (service_web.description == null) {
								pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(3, service_web.description);
							}

							if (service_web.adresse == null) {
								pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4, service_web.adresse);
							}

							if (service_web.telephone == null) {
								pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(5, service_web.telephone);
							}

							if (service_web.email == null) {
								pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(6, service_web.email);
							}

							if (service_web.nom == null) {
								pstmt_tDBOutput_1.setNull(7 + count_tDBOutput_1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(7 + count_tDBOutput_1, service_web.nom);
							}

							if (service_web.description == null) {
								pstmt_tDBOutput_1.setNull(8 + count_tDBOutput_1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(8 + count_tDBOutput_1, service_web.description);
							}

							if (service_web.adresse == null) {
								pstmt_tDBOutput_1.setNull(9 + count_tDBOutput_1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(9 + count_tDBOutput_1, service_web.adresse);
							}

							if (service_web.telephone == null) {
								pstmt_tDBOutput_1.setNull(10 + count_tDBOutput_1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(10 + count_tDBOutput_1, service_web.telephone);
							}

							if (service_web.email == null) {
								pstmt_tDBOutput_1.setNull(11 + count_tDBOutput_1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(11 + count_tDBOutput_1, service_web.email);
							}
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_extractionTrustPilots.class.getClassLoader().getResourceAsStream(
					"local_project/job_extractiontrustpilots_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = job_extractionTrustPilots.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : job_extractionTrustPilots");
		}
...
/************************************************************************************************
 * 163906 characters generated by Talend Open Studio for Data Integration on the
 * 25 mars 2020 16:35:01 CET
 ************************************************************************************************/