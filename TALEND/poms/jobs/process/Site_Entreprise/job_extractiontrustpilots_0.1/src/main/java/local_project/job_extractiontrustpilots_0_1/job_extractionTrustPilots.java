...
package local_project.job_extractiontrustpilots_0_1;
...
/**
 * Job: job_extractionTrustPilots Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class job_extractionTrustPilots implements TalendJob {
...
public String getFILE_path(){
	...
	private final String jobName = "job_extractionTrustPilots";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				job_extractionTrustPilots.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_extractionTrustPilots.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_job_extractionTrustPilots = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_job_extractionTrustPilots = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_job_extractionTrustPilots.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_job_extractionTrustPilots.length == 0) {
   					commonByteArray_LOCAL_PROJECT_job_extractionTrustPilots = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_job_extractionTrustPilots = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_job_extractionTrustPilots, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_job_extractionTrustPilots, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_job_extractionTrustPilots) {
    ...
    public int compareTo(row7Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.url, other.url);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class service_webStruct implements routines.system.IPersistableRow<service_webStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_job_extractionTrustPilots = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_job_extractionTrustPilots = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final service_webStruct other = (service_webStruct) obj;
	...
	public void copyDataTo(service_webStruct other) {
	...
	public void copyKeysDataTo(service_webStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(service_webStruct other) {
...
public static class ListeServiceStruct implements routines.system.IPersistableRow<ListeServiceStruct> {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final ListeServiceStruct other = (ListeServiceStruct) obj;
	...
	public void copyDataTo(ListeServiceStruct other) {

		other.nom_service = this.nom_service;
	            
	}

	public void copyKeysDataTo(ListeServiceStruct other) {
...
public static class a_pour_service_siteStruct implements routines.system.IPersistableRow<a_pour_service_siteStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_job_extractionTrustPilots = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_job_extractionTrustPilots = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final a_pour_service_siteStruct other = (a_pour_service_siteStruct) obj;
	...
	public void copyDataTo(a_pour_service_siteStruct other) {
	...
	public void copyKeysDataTo(a_pour_service_siteStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(a_pour_service_siteStruct other) {
...
service_webStruct service_web = new service_webStruct();
ListeServiceStruct ListeService = new ListeServiceStruct();
row2Struct row2 = new row2Struct();
row3Struct row3 = new row3Struct();
row6Struct row6 = new row6Struct();
a_pour_service_siteStruct a_pour_service_site = new a_pour_service_siteStruct();
	...
	currentComponent="tDBOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						if(execStat) {
							runStat.updateStatOnConnection("service_web"+iterateId, 0, 0);
						}
...
int count_tDBOutput_1=0;
	    ...
	    String insertIgnore_tDBOutput_1 = "INSERT IGNORE INTO `" + "service_web" + "` (`url_service`,`nom`,`description`,`adresse`,`telephone`,`email`) VALUES (?,?,?,?,?,?) ON DUPLICATE KEY UPDATE `nom` = ?,`description` = ?,`adresse` = ?,`telephone` = ?,`email` = ?";
	...
	currentComponent="tNormalize_2";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						if(execStat) {
							runStat.updateStatOnConnection("a_pour_service_site"+iterateId, 0, 0);
						}
...
service_webStruct service_web_tmp = new service_webStruct();
ListeServiceStruct ListeService_tmp = new ListeServiceStruct();
a_pour_service_siteStruct a_pour_service_site_tmp = new a_pour_service_siteStruct();
// ###############################
...
Object filenameOrStream_tFileInputJSON_1 = null;
        try {
            filenameOrStream_tFileInputJSON_1 = context.FILE_path+"/infosTrustPilot.com.json";
...
service_web = null;
ListeService = null;
a_pour_service_site = null;


// # Output table : 'service_web'
service_web_tmp.url_service = row1.id_entite ;
service_web_tmp.nom = row1.nom ;
service_web_tmp.description = row1.description ;
service_web_tmp.adresse = row1.adresse ;
service_web_tmp.telephone = row1.telephone ;
service_web_tmp.email = row1.email ;
service_web = service_web_tmp;
...
// # Output table : 'a_pour_service_site'
// # Filter conditions 
if( 
...
a_pour_service_site_tmp.nom = row1.categories.replaceAll("\\[\"", "").replaceAll("\"\\]", "").replaceAll("&#039;", "'") ;
a_pour_service_site_tmp.url = row1.id_entite ;
a_pour_service_site = a_pour_service_site_tmp;
} // closing filter/reject
// ###############################
...
if(service_web != null) { 
	...
	currentComponent="tDBOutput_1";
			...
			//service_web
				...
				if(execStat){
					runStat.updateStatOnConnection("service_web"+iterateId,1, 1);
				}
        ...
        whetherReject_tDBOutput_1 = false;
                    if(service_web.url_service == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, service_web.url_service);
}

                    if(service_web.nom == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, service_web.nom);
}

                    if(service_web.description == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, service_web.description);
}

                    if(service_web.adresse == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, service_web.adresse);
}

                    if(service_web.telephone == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, service_web.telephone);
}

                    if(service_web.email == null) {
pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6, service_web.email);
}

                    if(service_web.nom == null) {
pstmt_tDBOutput_1.setNull(7 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7 + count_tDBOutput_1, service_web.nom);
}

                    if(service_web.description == null) {
pstmt_tDBOutput_1.setNull(8 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(8 + count_tDBOutput_1, service_web.description);
}

                    if(service_web.adresse == null) {
pstmt_tDBOutput_1.setNull(9 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(9 + count_tDBOutput_1, service_web.adresse);
}

                    if(service_web.telephone == null) {
pstmt_tDBOutput_1.setNull(10 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(10 + count_tDBOutput_1, service_web.telephone);
}

                    if(service_web.email == null) {
pstmt_tDBOutput_1.setNull(11 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(11 + count_tDBOutput_1, service_web.email);
}
 ...
 */
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");    
        ope_tFilterRow_1.matches((row2.nom_service == null? false : row2.nom_service.length() > 0)
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row3 == null){ 
               ...
               row3.nom_service = row2.nom_service;    
...
// Start of branch "a_pour_service_site"
if(a_pour_service_site != null) { 
	...
	currentComponent="tNormalize_2";
			...
			//a_pour_service_site
				...
				if(execStat){
					runStat.updateStatOnConnection("a_pour_service_site"+iterateId,1, 1);
				}
            ...
            if(a_pour_service_site.nom != null) {
				if("".equals(a_pour_service_site.nom)){
		        	normalizeRecord_tNormalize_2[0] = "";
		        }else{
	                
	                		normalizeRecord_tNormalize_2 = a_pour_service_site.nom.split(";",-1);
            	...
            	for(int i_tNormalize_2 = 0 ; i_tNormalize_2 < lastNoEmptyIndex_tNormalize_2 ; i_tNormalize_2++) {
	                ...
	                nb_line_tNormalize_2++;               
	                        	...
	                        	row4.nom = normalizeRecord_tNormalize_2[i_tNormalize_2];
		                    
	                        	row4.url = a_pour_service_site.url;
 ...
 */
    ...
    Operator_tFilterRow_2 ope_tFilterRow_2 = new Operator_tFilterRow_2("&&");    
        ope_tFilterRow_2.matches((row4.nom == null? false : row4.nom.length() > 0)
                       , " nom.length() > 0 failed");
...
operation_finder_tAggregateRow_2.nom = row5.nom;
			operation_finder_tAggregateRow_2.url = row5.url;
...
} // End of branch "a_pour_service_site"
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
	 				runStat.updateStatOnConnection("service_web"+iterateId,2, 0);
			 	}
			}
 ...
 */
    ...
    globalMap.put("tNormalize_2_NB_LINE", nb_line_tNormalize_2);
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
	 				runStat.updateStatOnConnection("a_pour_service_site"+iterateId,2, 0);
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final job_extractionTrustPilots job_extractionTrustPilotsClass = new job_extractionTrustPilots();

        int exitCode = job_extractionTrustPilotsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = job_extractionTrustPilots.class.getClassLoader().getResourceAsStream("local_project/job_extractiontrustpilots_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_extractionTrustPilots.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_extractionTrustPilots");
        }
...
/************************************************************************************************
 *     163906 characters generated by Talend Open Studio for Data Integration 
