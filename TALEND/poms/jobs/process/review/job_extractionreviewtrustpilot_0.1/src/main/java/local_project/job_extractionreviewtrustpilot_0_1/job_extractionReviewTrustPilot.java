				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(job_extractionReviewTrustPilot.this,
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				strReturn = new String(commonByteArray_LOCAL_PROJECT_job_extractionReviewTrustPilot, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
...
// ------------
				...
				String insertIgnore_tDBOutput_3 = "INSERT IGNORE INTO `" + "commentaire"
						+ "` (`siret`,`auteur`,`date`,`note`,`commentaire`,`url_service`,`source`) VALUES (?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE `siret` = ?,`auteur` = ?,`date` = ?,`note` = ?,`commentaire` = ?,`url_service` = ?,`source` = ?";
				java.sql.PreparedStatement pstmt_tDBOutput_3 = conn_tDBOutput_3
						.prepareStatement(insertIgnore_tDBOutput_3);
					...
					try {
						...
						try {
							...
							if (value_tFileInputJSON_1 != null && !value_tFileInputJSON_1.toString().isEmpty()) {
								row1.date = ParserUtils.parseTo_Date(value_tFileInputJSON_1.toString(),
...
// Start of branch "row1"
					if (row1 != null) {
						...
						{ // start of Var scope
							...
							;
							Var.url = row1.idEntite.matches("[0-9]{14}") ? null : row1.idEntite;
							Var.siret = row1.idEntite.matches("[0-9]{14}") ? row1.idEntite : null;// ###############################
							// ###############################
							// # Output tables
...
// # Output table : 'commentaire'
							...
							commentaire_tmp.commentaire = row1.commentaire.replaceAll("&#39;", "'")
									.replaceAll("&#8217;", "'");
...
// Start of branch "commentaire"
						if (commentaire != null) {
							...
							if (commentaire.siret == null) {
								...
								pstmt_tDBOutput_3.setString(1, commentaire.siret);
							}

							if (commentaire.auteur == null) {
								pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(2, commentaire.auteur);
							}
							...
							if (commentaire.note == null) {
								...
								pstmt_tDBOutput_3.setFloat(4, commentaire.note);
							}

							if (commentaire.commentaire == null) {
								pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(5, commentaire.commentaire);
							}

							if (commentaire.url_service == null) {
								pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(6, commentaire.url_service);
							}

							if (commentaire.source == null) {
								pstmt_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(7, commentaire.source);
							}

							if (commentaire.siret == null) {
								pstmt_tDBOutput_3.setNull(8 + count_tDBOutput_3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(8 + count_tDBOutput_3, commentaire.siret);
							}

							if (commentaire.auteur == null) {
								pstmt_tDBOutput_3.setNull(9 + count_tDBOutput_3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(9 + count_tDBOutput_3, commentaire.auteur);
							}

							if (commentaire.date != null) {
								pstmt_tDBOutput_3.setTimestamp(10 + count_tDBOutput_3,
										new java.sql.Timestamp(commentaire.date.getTime()));
							} else {
								pstmt_tDBOutput_3.setNull(10 + count_tDBOutput_3, java.sql.Types.TIMESTAMP);
							}

							if (commentaire.note == null) {
								pstmt_tDBOutput_3.setNull(11 + count_tDBOutput_3, java.sql.Types.FLOAT);
							} else {
								pstmt_tDBOutput_3.setFloat(11 + count_tDBOutput_3, commentaire.note);
							}

							if (commentaire.commentaire == null) {
								pstmt_tDBOutput_3.setNull(12 + count_tDBOutput_3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(12 + count_tDBOutput_3, commentaire.commentaire);
							}

							if (commentaire.url_service == null) {
								pstmt_tDBOutput_3.setNull(13 + count_tDBOutput_3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(13 + count_tDBOutput_3, commentaire.url_service);
							}

							if (commentaire.source == null) {
								pstmt_tDBOutput_3.setNull(14 + count_tDBOutput_3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(14 + count_tDBOutput_3, commentaire.source);
							}

							int count_on_duplicate_key_tDBOutput_3 = 0;
							try {
								count_on_duplicate_key_tDBOutput_3 = pstmt_tDBOutput_3.executeUpdate();
...
// ###############################      
				...
				String insertIgnore_tDBOutput_1 = "INSERT IGNORE INTO `" + "source"
						+ "` (`url`,`nom`,`respecte_afnor`) VALUES (?,?,?) ON DUPLICATE KEY UPDATE `nom` = ?,`respecte_afnor` = ?";
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					if (row2.url == null) {
						...
						pstmt_tDBOutput_1.setString(1, row2.url);
					}

					if (row2.nom == null) {
						pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
					} else {
						pstmt_tDBOutput_1.setString(2, row2.nom);
					}

					if (row2.respecte_afnor == null) {
						pstmt_tDBOutput_1.setNull(3, java.sql.Types.BOOLEAN);
					} else {
						pstmt_tDBOutput_1.setBoolean(3, row2.respecte_afnor);
					}

					if (row2.nom == null) {
						pstmt_tDBOutput_1.setNull(4 + count_tDBOutput_1, java.sql.Types.VARCHAR);
					} else {
						pstmt_tDBOutput_1.setString(4 + count_tDBOutput_1, row2.nom);
					}

					if (row2.respecte_afnor == null) {
						pstmt_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.BOOLEAN);
					} else {
						pstmt_tDBOutput_1.setBoolean(5 + count_tDBOutput_1, row2.respecte_afnor);
					}
				...
				String insertIgnore_tDBOutput_2 = "INSERT IGNORE INTO `" + "auteur"
						+ "` (`nom`,`url`,`is_anonyme`) VALUES (?,?,?) ON DUPLICATE KEY UPDATE `is_anonyme` = ?";
				java.sql.PreparedStatement pstmt_tDBOutput_2 = conn_tDBOutput_2
						.prepareStatement(insertIgnore_tDBOutput_2);
				...
				for (AggOperationStruct_tAggregateRow_2 aggregated_row_tAggregateRow_2 : values_tAggregateRow_2) { // G_AggR_600
					...
					if (row3.auteur == null) {
						...
						pstmt_tDBOutput_2.setString(1, row3.auteur);
					}

					if (row3.source == null) {
						pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
					} else {
						pstmt_tDBOutput_2.setString(2, row3.source);
					}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = job_extractionReviewTrustPilot.class.getClassLoader().getResourceAsStream(
					"local_project/job_extractionreviewtrustpilot_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = job_extractionReviewTrustPilot.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : job_extractionReviewTrustPilot");
		}
...
/************************************************************************************************
 * 123653 characters generated by Talend Open Studio for Data Integration on the
 * 25 mars 2020 18:03:53 CET
 ************************************************************************************************/