...
package local_project.job_extractionreviewtrustedshops_0_1;
...
/**
 * Job: job_extractionReviewTrustedShops Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status 
 */
public class job_extractionReviewTrustedShops implements TalendJob {
...
public String getFILE_path(){
	...
	private final String jobName = "job_extractionReviewTrustedShops";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				job_extractionReviewTrustedShops.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(job_extractionReviewTrustedShops.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_job_extractionReviewTrustedShops = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_job_extractionReviewTrustedShops = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_job_extractionReviewTrustedShops.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_job_extractionReviewTrustedShops.length == 0) {
   					commonByteArray_LOCAL_PROJECT_job_extractionReviewTrustedShops = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_job_extractionReviewTrustedShops = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_job_extractionReviewTrustedShops, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_job_extractionReviewTrustedShops, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_job_extractionReviewTrustedShops) {
	...
	class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				int result = DEFAULT_HASHCODE;
							...
							result = prime * result + ((this.respecte_afnor == null) ? 0 : this.respecte_afnor.hashCode());
		...
		public boolean equals(Object obj) {
			...
			final AggOperationStruct_tAggregateRow_1 other = (AggOperationStruct_tAggregateRow_1) obj;
							...
							if (this.respecte_afnor == null) {
								if (other.respecte_afnor != null) 
									return false;
							} else if (!this.respecte_afnor.equals(other.respecte_afnor)) 
								return false;
...
Object filenameOrStream_tFileInputJSON_1 = null;
        try {
            filenameOrStream_tFileInputJSON_1 = context.FILE_path+"/reviewsTrustedShops.com.json";
...
operation_finder_tAggregateRow_1.url = source.url;
			operation_finder_tAggregateRow_1.respecte_afnor = source.respecte_afnor;
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_1.url = operation_finder_tAggregateRow_1.url;
				operation_result_tAggregateRow_1.respecte_afnor = operation_finder_tAggregateRow_1.respecte_afnor;
...
int count_tDBOutput_1=0;
	    ...
	    String insertIgnore_tDBOutput_1 = "INSERT IGNORE INTO `" + "source" + "` (`url`,`nom`,`respecte_afnor`) VALUES (?,?,?) ON DUPLICATE KEY UPDATE `url` = ?,`nom` = ?,`respecte_afnor` = ?";
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row2.respecte_afnor = aggregated_row_tAggregateRow_1.respecte_afnor;
...
} else {pstmt_tDBOutput_1.setString(4 + count_tDBOutput_1, row2.url);
}

                    if(row2.nom == null) {
pstmt_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5 + count_tDBOutput_1, row2.nom);
}

                    if(row2.respecte_afnor == null) {
pstmt_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.BOOLEAN);
} else {pstmt_tDBOutput_1.setBoolean(6 + count_tDBOutput_1, row2.respecte_afnor);
}
...
int count_tDBOutput_2=0;
	    ...
	    String insertIgnore_tDBOutput_2 = "INSERT IGNORE INTO `" + "auteur" + "` (`nom`,`url`,`is_anonyme`) VALUES (?,?,?) ON DUPLICATE KEY UPDATE `nom` = ?,`url` = ?,`is_anonyme` = ?";
...
} else {pstmt_tDBOutput_2.setString(4 + count_tDBOutput_2, row3.auteur);
}

                    if(row3.source == null) {
pstmt_tDBOutput_2.setNull(5 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5 + count_tDBOutput_2, row3.source);
}

                    pstmt_tDBOutput_2.setBoolean(6 + count_tDBOutput_2, row3.is_anonyme);
 ...
 */
    ...
    public static void main(String[] args){
        final job_extractionReviewTrustedShops job_extractionReviewTrustedShopsClass = new job_extractionReviewTrustedShops();

        int exitCode = job_extractionReviewTrustedShopsClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = job_extractionReviewTrustedShops.class.getClassLoader().getResourceAsStream("local_project/job_extractionreviewtrustedshops_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = job_extractionReviewTrustedShops.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : job_extractionReviewTrustedShops");
        }
...
/************************************************************************************************
 *     125137 characters generated by Talend Open Studio for Data Integration 
